...
The Direct Multiple Shooting numerical method produced much better results than Direct Shooting. While Direct Shooting had trouble optimizing the control, Direct Multiple Shooting was able to optimize the control almost as good as the indirect methods. The difference between the two direct methods is that Direct Multiple Shooting allows for the use of multiple rather than single polynomials. When looking at the results using Direct Multiple Shooting, it is noticeable that the degree of the polynomial does not really make a difference in coming up with an optimal solution (since the terminal time and mass are the same in all cases). The main difference is that increasing the polynomial degree also increases the computational cost. For example, the solution for the case of 2 intervals with polynomial degree 2 converged after 33 iterations and 0.937 seconds while the solution for the case of 2 intervals with polynomial degree 6 converged after 48 iterations and 1.72 seconds. This is approximately a 59\% difference. While this percentage may seem high, the magnitude of the difference for this example is low, which is not the case for the 16-interval solutions. For the case of 16 intervals with polynomial degree 2 converged 80 seconds while the solution for the case of 16 intervals with polynomial degree 6 converged in 184 seconds. This is a 104 second difference which is about 79\%. This is significant and shows that for this particular problem, the \(2^{nd}\) degree polynomial control is more optimal than the \(6^{th}\) degree polynomial control. 
 ...
 \begin{tabular}{ |p{3cm}||p{3cm}|  }
	...
	$\Delta_t$ & $[1,2]$ \\
	\hline
	$\sigma_\mathrm{init}=$ &  9\\
	\hline
	$\sigma_\mathrm{sys}=$ & 1\\
	\hline
	$\sigma_\mathrm{obs}=$ & $\frac{S_\mathrm{max}}{9n}$\\
	\hline
	$\hat{x}_0$ & 0 \\
	\hline
	$P_0$ & 0 \\
...
\begin{center}
	\begin{tabular}{||c c c c c c||} 
		...
		\hline\hline
		2        & 2           & 33             & 0.7972   & 3.2488794     & 0.75535473\\ 
		\hline
		2        & 4           & 59             & 3.0869   & 3.2478550     & 0.75543187\\
		\hline
		2        & 8           & 75             & 13.8941  & 3.2478042     & 0.75543560\\
		\hline
		2        & 16          & 112            & 79.1192  & 3.2477120     & 0.75544264\\ [1ex] 
%		\hline
%		5 & 88 & 788 & 6344 \\ [1ex] 
		\hline
	\end{tabular}
