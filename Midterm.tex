...
%	\includegraphics[scale=0.75]{directStatesK4Poly6.eps}
	\includegraphics[scale=0.50]{directStatesK4Poly6.eps}
...
%	\includegraphics[scale=0.75]{directControlK4Poly6.eps}
	\includegraphics[scale=0.50]{directControlK4Poly6.eps}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.50]{directStatesK8Poly6.eps}
	\caption{States for trajectory that minimizes fuel consumption (\(K:8\ , N:6\))}
	\label{fig:directStatesK8Poly6}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[scale=0.50]{directControlK8Poly6.eps}
...
\section{Appendix}
\lstinputlisting[label=midtermindirectshootingmain,      caption = midterm\_indirect\_shooting\_main.m]{midterm_indirect_shooting_main.m}
\lstinputlisting[label=indirectOrbitTransferError,       caption = indirectOrbitTransferError.m]{indirectOrbitTransferError.m}
\lstinputlisting[label=orbitTransferOde,                 caption = orbitTransferOde.m]{orbitTransferOde.m}
\lstinputlisting[label=midtermindirectmutlishootingmain, caption = midterm\_indirect\_mutli\_shooting\_main.m]{midterm_indirect_mutli_shooting_main.m}
\lstinputlisting[label=indirectMultiOrbitTransferError,  caption = indirectMultiOrbitTransferError.m]{indirectMultiOrbitTransferError.m}
\lstinputlisting[label=midtermdirectshootingmain,        caption = midterm\_direct\_shooting\_main.m]{midterm_direct_shooting_main.m}
\lstinputlisting[label=directOrbitTransferError,         caption = directOrbitTransferError.m]{directOrbitTransferError.m}
\lstinputlisting[label=directOrbitTransferOde,           caption = directOrbitTransferOde.m]{directOrbitTransferOde.m}
\lstinputlisting[label=orbitTransferObj,                 caption = orbitTransferObj.m]{orbitTransferObj.m}
\lstinputlisting[label=midtermdirectmutlishootingmain,   caption = midterm\_direct\_mutli\_shooting\_main.m]{midterm_direct_mutli_shooting_main.m}
\lstinputlisting[label=directMultiOrbitTransferError,    caption = directMultiOrbitTransferError.m]{directMultiOrbitTransferError.m}
\end{document}
